...
struct Pad {
    ...
    // TODO: Another Pad(...) constructor is skipped
    // ... due to its dependency on ExPolygons
    // ... also, Pad is not a priority at this point
...
class SupportTreeBuilder: public SupportTree {
    ...
    // TODO: Pad is not a priority and is skipped
    // ... but just keep this member for now
    Pad m_pad;
...
public:
    ...
    // 16 is enough to be almost a circle
    // 16 is used by Qt3D when creating spheres and cylinders
    // https://github.com/qt/qt3d/blob/980bb6047455b399323efc4879c4ec5e62a5cb96/src/extras/geometries/qspheregeometry.cpp#L173
    // https://github.com/qt/qt3d/blob/980bb6047455b399323efc4879c4ec5e62a5cb96/src/extras/geometries/qcylindergeometry.cpp#L186
    // Let's try even smaller: 12
    //
    // WITHOUT THE PAD!!!
    const TriangleMesh &merged_mesh(size_t steps = 12) const;
    ...
    // TODO: add_pad is already skipped on SupportTree

    // TODO: remove_pad is already skipped on SupportTree
