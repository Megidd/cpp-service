                                    ...
                                    )
{
    ...
    auto progress = [&builder, &pc, suppHandler /* For progress bar update */] () {
        static const std::array<std::string, NUM_STEPS> stepstr {
            "Start", /* "Starting", */
            "Filter", /* "Filtering", */
            "Create tips", /* "Generate pinheads", */
            "Categorize", /* "Classification", */
            "Body-to-floor", /* "Routing to ground", */
            "Body-to-body", /* "Routing supports to model surface", */
            "Cross brace", /* "Interconnecting pillars", */
            "Create mesh", /* "Merging support mesh", */
            "Done",
            "Abort"
        };
                                                 ...
                                                 long         head_id)
{
    ...
    {
#ifdef BYPASS_CXX17_FEATURES
        std::experimental::optional<DiffBridge> diffbr =
...
#ifdef BYPASS_CXX17_FEATURES
std::experimental::optional<DiffBridge> SupportTreeBuildsteps::search_widening_path(
#else // BYPASS_CXX17_FEATURES
