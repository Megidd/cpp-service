#ifndef SUPPORTTREEBUILDSTEPS_HPP
#define SUPPORTTREEBUILDSTEPS_HPP

#include "libslic3r/SLA/SupportTreeBuilder.hpp"
#include <map> // for std::map

#ifdef BYPASS_CXX17_FEATURES
// https://stackoverflow.com/a/38254000/3405291
#include <experimental/optional>
#else // BYPASS_CXX17_FEATURES
#include <optional> // for std::optional
#endif // BYPASS_CXX17_FEATURES

#include <array> // for error: type 'const std::array<double, 2>' does not provide a subscript operator
...
// Originally inside src/libslic3r/SLA/Pad.hpp
...
#ifdef BYPASS_CXX17_FEATURES
    std::experimental::optional<DiffBridge> search_widening_path(const Vec3d &jp,
#else // BYPASS_CXX17_FEATURES
...
#endif // SUPPORTTREEBUILDSTEPS_HPP
